            ...
            <div className="container mx-auto px-4 py-12">
                        ...
                        <div className="grid grid-cols-4 gap-8 text-left">
                            {footerSections.map((section) => (
                                <AccordionItem key={section.title} value={section.title} className="border-b-0">
                                    <AccordionTrigger className="text-sm uppercase tracking-widest hover:no-underline font-semibold py-2">
                                        {section.title}
                                    </AccordionTrigger>
                                    <AccordionContent>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
                    ...
                    <div className="md:text-center">
                        ...
                        <p className="mt-4 text-sm text-neutral-600 max-w-xs md:mx-auto">
                            Receive our newsletter and discover our stories, collections, and surprises.
                        </p>
                        <Button variant="outline" className="mt-6 rounded-none uppercase text-xs tracking-widest px-8">
                            Subscribe
                        </Button>
                    </div>
