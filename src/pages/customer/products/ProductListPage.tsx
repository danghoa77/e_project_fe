    ...
    if (error) {
        return (
            <div className="flex h-screen w-full flex-col items-center justify-center text-center">
                ...
                <h3 className="font-serif text-2xl text-neutral-700">Failed to load products</h3>
                <p className="max-w-xs mt-2 text-neutral-500">There was an error fetching products. Please try again later.</p>
            </div>
        )
    }
            ...
            <div className="container mx-auto px-8 py-12 md:py-16">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                    ...
                    <main className="col-span-1 lg:col-span-3">
                        ...
                        {loading ? (
                            <div className="flex justify-center items-center h-96"><Loader2 className="h-8 w-8 animate-spin text-neutral-500" /></div>
                        ) : products.length > 0 ? (
                            <div>
                            ...
                            <div className="flex flex-col items-center justify-center h-96 text-center text-neutral-500">
                                ...
                                <p className="max-w-xs">There are no products that match your current filters.</p>
                            </div>
                        )}
                    </main>
                </div>
