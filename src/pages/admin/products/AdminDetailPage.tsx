...
export const AdminDetailPage = () => {
    ...
    const [hoveredVariantId, setHoveredVariantId] = React.useState<string | null>(null);
    ...
    return (
        <main className="bg-stone-50 min-h-screen font-sans">
            <div className="max-w-7xl mx-auto p-4 sm:p-8">
                <Button onClick={() => navigate(-1)} variant="ghost" className="mb-6 text-stone-600 hover:text-stone-900">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12 items-start">
                    ...
                    <div className="lg:col-span-3 space-y-6">
                        <div>
                            <p className="text-sm font-bold uppercase tracking-wider text-orange-600">{product.category}</p>
                                            ...
                                            <div className="text-sm">
                                                ...
                                                <span className="ml-2">
                                                    {v.salePrice && v.salePrice < v.price ? (
                                                        <>
                                                            <span className="text-orange-600 font-bold">{formatPrice(v.salePrice)}</span>
                                                            <span className="ml-2 line-through text-xs text-neutral-500">{formatPrice(v.price)}</span>
                                                        </>
                                                    ) : (
