    ...
    <div className="p-8 bg-stone-50 min-h-screen font-sans">
      <div className="flex justify-between items-center mb-6">
        ...
        <Button
          ...
          className="bg-orange-600 text-white hover:bg-orange-700 flex items-center gap-2 shadow-sm"
        >
      ...
      <div className="rounded-lg border border-stone-200 bg-white shadow-sm overflow-hidden">
        <Table>
          <TableHeader className="bg-stone-100">
            <TableRow>
              <TableHead className="text-stone-600 text-xs uppercase tracking-wider">
                Image
              </TableHead>
              <TableHead className="text-stone-600 text-xs uppercase tracking-wider">
                Name
              ...
              <TableHead className="text-right text-stone-600 text-xs uppercase tracking-wider">
                Actions
              </TableHead>
            </TableRow>
          </TableHeader>
              ...
              ? Array.from({ length: 5 }).map((_, i) => (
                  <TableRow key={i}>
                    {Array.from({ length: 8 }).map((__, j) => (
                      <TableCell key={j}>
                        <Skeleton className="h-5 w-full bg-stone-200" />
                      </TableCell>
                    ))}
                  </TableRow>
                ))
              : products.map((p) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell className="text-stone-600 text-center">
                        {p.variants?.length || 0}
                      </TableCell>
                      <TableCell className="text-stone-800 font-semibold">
                        ...
                        firstVariant.salePrice < firstVariant.price ? (
                          <div className="flex flex-col">
                            ...
                            <span className="line-through text-sm text-stone-500 font-normal">
                      ...
                      <TableCell className="text-right">
                        <div className="flex gap-2 justify-end">
                          ...
                          <Button
                            size="sm"
                            variant="outline"
                            className="border-stone-300 text-red-600 hover:text-red-700 disabled:opacity-50"
